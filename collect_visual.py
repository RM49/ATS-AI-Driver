...
def preprocess_image(img: Image.Image) -> np.ndarray:
    ...
    # surface = pygame.surfarray.make_surface(grayscale_img.tobytes())
    screen.blit(grayscale_img, (0, 0))
    pygame.display.flip()
...
# --- Pygame setup ---
pygame.init()
pygame_window_size = (200, 66)
screen = pygame.display.set_mode(pygame_window_size)
pygame.display.set_caption("Grayscale Preprocessed Image")
