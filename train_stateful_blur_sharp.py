# train.py (Stateful & 6x Deterministic Augmentation)
...
def data_generator(log_df, batch_size=32, num_frames=4, augment=False):
    ...
    # Define the sharpening kernel once
...
model.save("ats_driver_model_6x_augmented.h5")
print("6x augmented model saved successfully!")
